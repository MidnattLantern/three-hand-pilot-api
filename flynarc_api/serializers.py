...
#    user_authentication_id = serializers.ReadOnlyField(source='profile.id')
    user_authentication_id = serializers.ReadOnlyField(source='userauthentication.id')
#    user_authentication_image = serializers.ReadOnlyField(source='profile.image.url')
    user_authentication_image = serializers.ReadOnlyField(source='userauthentication.image.url')
